...
chatForm?.addEventListener("submit", event => {
  ...
  const emailSubject =
    encodeURIComponent("Key Doctor Chat Request");

  const emailBody =
    encodeURIComponent(
      `New chat request from Key Doctor website:\n\n${text}\n\nPlease reply to this customer as soon as possible.`
    );
  ...
  setTimeout(() => {
    ...
    botMsg.textContent =
      "Thanks. Your email app will open so this request can be sent to Key Doctor.";
